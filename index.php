...
<div class="container">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block img-fluid" src="<?php echo wp_get_attachment_url(get_theme_mod('featured_post_image_one_setting'));?>" style="max-width:100%;height:auto;" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block img-fluid" src="<?php echo wp_get_attachment_url(get_theme_mod('featured_post_image_two_setting'));?>" style="max-width:100%;height:auto;" alt="Second slide">
	  <div class="carousel-caption d-none d-md-block">
	  <div class="cover">
    ...
    <div class="carousel-item">
      <img class="d-block img-fluid" src="<?php echo wp_get_attachment_url(get_theme_mod('featured_post_image_three_setting'));?>" style="max-width:100%;height:auto;" alt="Third slide">
	  <div class="carousel-caption d-none d-md-block">
	  <div class="cover">
	...
	<div class="carousel-item">
      <img class="d-block img-fluid" src="<?php echo wp_get_attachment_url(get_theme_mod('featured_post_image_four_setting'));?>" style="max-width:100%;height:auto;" alt="Fourth slide">
	  <div class="carousel-caption d-none d-md-block">
	  <div class="cover">
				...
				<div class="row">
					...
					<div id="London" class="col-md-9 tabcontent">
					  ...
					  <?php
						...
						$args = array( 'numberposts' => '3', 'category'=>$mod2, 'order'=>'ASC' );
						...
						foreach( $recent_posts as $recent ){
							...
							<?php	the_post_thumbnail($post=$recent["ID"]);					
								...
								echo '<p class="post-excerpt">Loren Ipsum dolor sit amet,con-sectetur adipiscing elit. Aenean et sollicitudin risus
';
							echo '&rarr;</p></div>
